      ...
      f1Client.on(PACKET, function (val) {
          ...
          switch(PACKET){
            ...
            case PACKETS.carTelemetry:
              ...
              sendPacketDataToConnect(socket, 'carTelemetry_brakesTemperature', `${val.m_carTelemetryData[playerIndex].m_brakesTemperature[0]},${val.m_carTelemetryData[playerIndex].brakesTemperature[1]},${val.m_carTelemetryData[playerIndex].m_brakesTemperature[2]},${val.m_carTelemetryData[playerIndex].m_brakesTemperature[3]}`);
